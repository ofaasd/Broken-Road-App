...
<script>
	if(localStorage.token != undefined){
		...
		.then(function(){
		  //load list
		  const url = "http://sinarbarokahsmg.com/apibr/public/api/pelanggan";
		  fetch(url,{
		  	method : "GET",
		  	headers : {
	...
	const tagging = (id) =>{
	    ...
	    .then(function(){
	    	const url = "http://sinarbarokahsmg.com/apibr/public/api/pelanggan/"+id;
			fetch(url,{
			  	method : "GET",
			  	headers : {
			  		"Authorization" : localStorage.token,
	...
	const edit = () => { 
	    ...
	    .pushPage('edit.html')
	    .then(function(){
	    	const url = "http://sinarbarokahsmg.com/apibr/public/api/pelanggan/"+myid;
			fetch(url,{
			  	method : "GET",
			  	headers : {
			  		"Authorization" : localStorage.token,
...
//		    		alert(obj['status']);
	...
	const update = () => {
	  ...
	  const url = "http://sinarbarokahsmg.com/apibr/public/api/pelanggan/"+ids+"?nama="+nama+"&nohp="+nohp+"&nohpalt="+nohpalt+"&keterangan="+keterangan+"&status="+status;
	  fetch(url,{
	  	method : "PUT",
	  	headers : {
	  		"Authorization" : localStorage.token,
	...
	function search(){
		...
		const by = $('#by').val();
		const url = "http://sinarbarokahsmg.com/apibr/public/api/pelanggan/cari?search="+keyword+"&by="+by;
		fetch(url,{
		  	method : "GET",
		  	headers : {
		  		"Authorization" : localStorage.token,
	...
	const login = () => {
	  ...
	  const url = "http://sinarbarokahsmg.com/apibr/public/oauth/token";
	  const formData = new FormData();
